...
},{}],"diceYA.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getRandom = exports.dicePositions = exports.diceRoll = void 0;
var dicePositions = {};
exports.dicePositions = dicePositions;
...
var diceMoveZ = function diceMoveZ(times) {
...
var diceMoveUp = function diceMoveUp(times) {
...
var diceMoveRight = function diceMoveRight(times) {
  var tempFront, tempBack;
...
var diceRoll = function diceRoll() {
  ...
  var zRand = getRandom(max, min);
  var rotationX = xRand % 360 / 90;
  var rotationY = yRand % 360 / 90;
  var rotationZ = zRand % 360 / 90; //change settlement angle(add x and y angle random(25,0) degree), so that each roll ends up with different visual

  cube.style.transform = "rotateX(".concat(xRand + getRandom(22, 0) / 90, "deg) rotateY(").concat(yRand + getRandom(22, 0) / 90, "deg) rotateZ(").concat(zRand + getRandom(22, 0) / 90, "deg)"); //until transformation will end, .5sec is determined in css , disable click events on dice.
  ...
  setTimeout(function () {
    ...
    diceMoveUp(rotationX); //cube.style.pointerEvents = "all";
  }, 510);
};

exports.diceRoll = diceRoll;
},{}],"dice game.js":[function(require,module,exports) {
"use strict";
...
var messageToPlyr0 = document.getElementById("message--0");
var messageToPlyr1 = document.getElementById("message--1");
var btnNew = document.querySelector(".btn--new");
var btnHold = document.querySelector(".btn--hold");
var btnRoll = document.querySelector(".btn--roll");
var player0El = document.querySelector(".player--0");
var player1El = document.querySelector(".player--1");
var nameContainer = document.querySelectorAll(".name");
var cube = document.getElementById("cube");
var faces = [document.querySelector(".front"), document.querySelector(".back"), document.querySelector(".left"), document.querySelector(".right"), document.querySelector(".top"), document.querySelector(".bottom")];
var scores,
    currentScore,
    activePlayer = 1,
    playing = false;

var waitRolligDice = function waitRolligDice(sec) {
  return new Promise(function (resolve) {
    return setTimeout(resolve, 1000 * sec);
  });
};

var changeDiceColor = function changeDiceColor() {
  var color = "rgba(" + (0, _diceYA.getRandom)(26, 0) / 9 + "," + (0, _diceYA.getRandom)(26, 0) / 9 + "," + (0, _diceYA.getRandom)(26, 0) / 9 + "," + (Math.random() + 0.5) + ")";
...
var init = function init() {
  ...
  if (activePlayer) gameMessages("please wait", "please roll");else gameMessages("please roll", "please wait");
  document.querySelector(".player--".concat(activePlayer)).classList.add("player--active");
  document.getElementById("message--".concat(activePlayer)).style.color = "white";
  document.getElementById("message--".concat(1 - activePlayer)).style.color = "rgba(122, 118, 118, 0.68)";
};
...
var deactivateRollButtons = function deactivateRollButtons() {
  return cube.style.pointerEvents = btnRoll.style.pointerEvents = "none";
};

var activateRollButtons = function activateRollButtons() {
  return cube.style.pointerEvents = btnRoll.style.pointerEvents = "all";
};

var gameMessages = function gameMessages() {
  var message0 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  var message1 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  ...
  if (_diceYA.dicePositions.front === 1) {
    document.getElementById("message--".concat(activePlayer)).textContent = "bad luck";
    document.getElementById("message--".concat(1 - activePlayer)).textContent = "your turn, please roll";
    return;
  }

  if (message0 === "hold") {
    document.getElementById("message--".concat(activePlayer)).textContent = "current score is added to total ";
    document.getElementById("message--".concat(1 - activePlayer)).textContent = "your turn, please roll";
    return;
  }

  document.getElementById("message--".concat(activePlayer)).textContent = "".concat(_diceYA.dicePositions.front, ", roll or hold?");
  document.getElementById("message--".concat(1 - activePlayer)).textContent = "please wait";
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (0, _diceYA.diceRoll)(); //until dice settles, u cant click

            deactivateRollButtons(); //wait dice settlement

            _context.next = 5;
            return waitRolligDice(0.6);

          case 5:
            //can click now
            activateRollButtons(); //const dice = dicePositions.front;
            //give information about current situation to players

            gameMessages(); //check for rolled 1

            changeDiceColor();

            if (_diceYA.dicePositions.front !== 1) {
              currentScore += _diceYA.dicePositions.front;
              document.getElementById("current--".concat(activePlayer)).textContent = currentScore;
            } else {
...
btnHold.addEventListener("click", function () {
  ...
  if (playing) {
    ...
    document.getElementById("score--".concat(activePlayer)).textContent = scores[activePlayer]; //check winner

    if (scores[activePlayer] >= 100) {
      //end game
      playing = false;
      messageToPlyr0.textContent = messageToPlyr1.textContent = ""; //css change to winner player's container

      document.querySelector(".player--".concat(activePlayer)).classList.add("player--winner"); //remove active player css

      document.querySelector(".player--".concat(activePlayer)).classList.remove("player--active"); //change name of winner player

      nameContainer[activePlayer].textContent = "WINNER"; //change name of loser player
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            cube.style.transform = "rotateX(".concat(Math.random() * 360, "deg) rotateY(").concat(Math.random() * 360, "deg) rotateZ(").concat(Math.random() * 360, "deg)");
            _context2.next = 6;
            return waitRolligDice(1.5);
...
simulate();
},{"core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./diceYA.js":"diceYA.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","dice game.js"], null)
//# sourceMappingURL=/dice%20game.2969f5d5.js.map