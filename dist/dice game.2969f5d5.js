...
var diceRoll = function diceRoll() {
  ...
  cube.style.transform = "rotateX(" + (xRand + getRandom(22, 0) / 90) + "deg) rotateY(" + (yRand + getRandom(22, 0) / 90) + "deg) " + "rotateZ(" + (zRand + getRandom(22, 0) / 90) + "deg)"; //until transformation will end, .5sec is determined in css , disable click events on dice.
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            cube.style.transform = "rotateX(".concat((0, _diceYA.getRandom)(4) + 25, "deg) rotateY(").concat((0, _diceYA.getRandom)(4) + 45, "deg) rotateZ(").concat((0, _diceYA.getRandom)(4) + 75, "deg)");
            _context2.next = 7;
...
simulate();
},{"color-name":"node_modules/color-name/index.js","core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./diceYA.js":"diceYA.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
