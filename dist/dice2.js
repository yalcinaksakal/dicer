...
cube.onclick = function () {
  ...
  cube.style.transform =
    "rotateX(" +
    (xRand + getRandom(20, 0) / 90) +
    "deg) rotateY(" +
    (yRand + getRandom(20, 0) / 90) +
    "deg) " +
    "rotateZ(" +
    (zRand + getRandom(20, 0) / 90) +
    "deg)";

  //until transformation will end, 1.5sec is determined in css , disable click events on dice.
